        ...
        <div className="grid m-12 md:m-0 md:grid-cols-2 gap-12 lg:gap-60">
          <div className="md:p-8 rounded-lg service-card group hover:transform-none button">
            ...
            <p className="text-gray-400 text-lg group-hover:text-gray-300 transition-colors duration-100">
              Chrome extension enabled by ChatGPT AI to deliver users instant
              content insights.
            </p>
          </div>
        </div>
      ...
      <div className="mt-10 mb-32 px-0 mx-0 grid grid-cols-1 xxs:grid-cols-1 xs:grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <div className="p-8 service-card">
          ...
          <p className="mt-5 text-white opacity-50 text-lg">
            ...
            needs, ensuring that every solution we provide is aligned with your
            success metrics, making your victory our victory.
          </p>
        </div>
        <div className="p-8 service-card">
        ...
        <div className="p-8 service-card">
          ...
          <p className="mt-5 text-white opacity-50 text-lg">
            In the digital realm, security is paramount. We protect your assets
            with state-of-the-art security protocols, guarding your business
            against threats, so you can operate with peace of mind.
          </p>
        </div>
      </div>
      {/* </Fade> */}
